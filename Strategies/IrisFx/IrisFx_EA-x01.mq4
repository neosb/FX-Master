...
int start()
{
   ...
   if ( strategy > 3 || strategy < 1 ) Alert("Strategy should be = either 1, 2 or 3");
   ...
   {
      if ( Period() == PERIOD_H1 ) strategy = 1;
      if ( Period() == PERIOD_H4 ) strategy = 3;
   }
   return(0);
}
...
void func1()
{
   ...
   if (li_152 || li_156 || li_144 || g_ihigh_132 == 0.0 || g_ilow_140 == 0.0 || g_lots_212 == 0.0 || g_lots_220 == 0.0 || g_price_148 == 0.0 || g_price_156 == 0.0 || g_price_164 == 0.0 ||
      ...
      g_lots_220 = AccountBalance() * ld_0;
      g_lots_212 = AccountBalance() * ld_0;
      ...
      if (AccountBalance() > 500.0)
      {
         ...
         for (li_148 = OrdersHistoryTotal() - 1; li_148 >= 0; li_148--)
         {
            ...
            {
               if (OrderLots() <= AccountBalance() * ld_0)
               {
                  g_lots_220 = AccountBalance() * ld_0;
                  g_lots_212 = AccountBalance() * ld_0;
                  break;
               }
               g_lots_220 = OrderLots();
               g_lots_212 = OrderLots();
               break;
            }
         }
      }
      ...
      if ( g_lots_220 > AccountFreeMargin() / (1.05 * g_marginrequired_228) || g_lots_212 > AccountFreeMargin() / (1.05 * g_marginrequired_228))
      {
         g_lots_220 = AccountFreeMargin() / (1.05 * g_marginrequired_228);
         g_lots_212 = AccountFreeMargin() / (1.05 * g_marginrequired_228);
      }
   }
   bool li_172 = TRUE;
   ...
   bool li_216 = TRUE;
   bool li_220 = TRUE;
   for (li_148 = OrdersTotal()-1; li_148 >= 0; li_148--)
   {
      ...
      if (OrderType() == OP_BUYSTOP && OrderSymbol() == Symbol() && OrderMagicNumber() == Magic1) {
         ...
         if (OrderOpenPrice() - g_price_148 >= Strategy1_TrailingStart * Point || g_price_148 - OrderOpenPrice() >= Strategy1_TrailingStart * Point && Ask <= OrderOpenPrice() - l_stoplevel_160 * Point) OrderModify(OrderTicket(), g_price_148, g_price_180, g_price_164, 0, Blue);
         else
            if (OrderOpenPrice() - g_price_148 < Strategy1_TrailingStart * Point || g_price_148 - OrderOpenPrice() < Strategy1_TrailingStart * Point && Ask <= OrderOpenPrice() - l_stoplevel_160 * Point && NormalizeDouble(OrderOpenPrice(), gi_280) != NormalizeDouble(g_price_148, gi_280)) OrderModify(OrderTicket(), g_price_148, g_price_180, g_price_164, 0, CLR_NONE);
      ...
      if (OrderType() == OP_SELLSTOP && OrderSymbol() == Symbol() && OrderMagicNumber() == Magic1) {
         ...
         if (OrderOpenPrice() - g_price_156 >= Strategy1_TrailingStart * Point || g_price_156 - OrderOpenPrice() >= Strategy1_TrailingStart * Point && Bid >= OrderOpenPrice() + l_stoplevel_160 * Point) OrderModify(OrderTicket(), g_price_156, g_price_188, g_price_172, 0, Red);
         else
            if (OrderOpenPrice() - g_price_156 < Strategy1_TrailingStart * Point || g_price_156 - OrderOpenPrice() < Strategy1_TrailingStart * Point && Bid >= OrderOpenPrice() + l_stoplevel_160 * Point && NormalizeDouble(OrderOpenPrice(), gi_280) != NormalizeDouble(g_price_156, gi_280)) OrderModify(OrderTicket(), g_price_156, g_price_188, g_price_172, 0, CLR_NONE);
   ...
   g_lots_220 = NormalizeLot ( g_lots_220 );
   g_lots_212 = NormalizeLot ( g_lots_212 );
...
void func2()
{
   ...
   double l_price_256;
   double l_price_264;
   double MyRisk = lot_percent / 10000.0;
   double ld_8 = lot_fixed;
   double ld_16 = 12;
   double ld_24 = 22;
   double ld_32 = 75;
   ...
   if (li_132 || g_lots_520 == 0.0 || g_lots_528 == 0.0 || g_price_456 == 0.0 || g_price_464 == 0.0 || g_price_472 == 0.0 || g_price_480 == 0.0 || g_price_488 == 0.0 ||
      ...
      g_lots_528 = AccountBalance() * MyRisk;
      g_lots_520 = AccountBalance() * MyRisk;
      if (AccountBalance() > 500.0)
      {
         for (li_160 = OrdersHistoryTotal() - 1; li_160 >= 0; li_160--)
         {
            ...
            {
               if (OrderLots() <= AccountBalance() * MyRisk) {
                  g_lots_528 = AccountBalance() * MyRisk;
                  g_lots_520 = AccountBalance() * MyRisk;
                  break;
               }
               g_lots_528 = OrderLots();
               g_lots_520 = OrderLots();
               break;
            }
         }
      }
      ...
      if (g_lots_528 > AccountFreeMargin() / (1.05 * g_marginrequired_536) || g_lots_520 > AccountFreeMargin() / (1.05 * g_marginrequired_536))
      {
         g_lots_528 = AccountFreeMargin() / (1.05 * g_marginrequired_536);
         g_lots_520 = AccountFreeMargin() / (1.05 * g_marginrequired_536);
      }
   }
   bool li_164 = TRUE;
   /*
   ...
   */
               ...
               if (li_172 == FALSE) OrderDelete(OrderTicket());
                  ...
                  if (li_44 && MathAbs(OrderOpenPrice() - l_ord_open_price_192) / Point < l_stoplevel_136) {
                     ...
                     if (show_orders == FALSE && Close[0] - OrderOpenPrice() > 300.0 * Point) {
                        ...
                        //if (OrderLots() != g_lots_520) OrderDelete(OrderTicket());
                     }
                  }
               }
            }
   ...
   g_lots_528 = NormalizeLot ( g_lots_528 );
   g_lots_520 = NormalizeLot ( g_lots_520 );
...
void func3() {
   ...
   if (li_132 || g_lots_788 == 0.0 || g_lots_796 == 0.0 || g_price_724 == 0.0 || g_price_732 == 0.0 || g_price_740 == 0.0 || g_price_748 == 0.0 || g_price_756 == 0.0 ||
      ...
      g_lots_796 = AccountBalance() * MyRisk;
      g_lots_788 = AccountBalance() * MyRisk;
      ...
      if (AccountBalance() > 500.0)
      {
         ...
         for (li_160 = OrdersHistoryTotal() - 1; li_160 >= 0; li_160--)
         {
            ...
            if (OrderSymbol() == Symbol() && OrderMagicNumber() == Magic3)
            {
               ...
               g_lots_796 = OrderLots();
               g_lots_788 = OrderLots();
               break;
            }
         }
      }
      ...
      if (g_lots_796 > AccountFreeMargin() / (1.05 * g_marginrequired_804) || g_lots_788 > AccountFreeMargin() / (1.05 * g_marginrequired_804))
      {
         g_lots_796 = AccountFreeMargin() / (1.05 * g_marginrequired_804);
         g_lots_788 = AccountFreeMargin() / (1.05 * g_marginrequired_804);
      }
   }
   bool li_164 = TRUE;
   /*
   ...
   */
   ...
   g_lots_796 = NormalizeLot ( g_lots_796 );
   g_lots_788 = NormalizeLot ( g_lots_788 );
