...
int start() {
   ...
   for (int l_shift_4 = Nbars; l_shift_4 >= 0; l_shift_4--) {
      g_ibuf_124[l_shift_4] = 0;
      g_ibuf_128[l_shift_4] = 0;
      g_ibuf_132[l_shift_4] = 0;
      g_ibuf_136[l_shift_4] = 0;
      g_ibuf_140[l_shift_4] = EMPTY_VALUE;
      g_ibuf_144[l_shift_4] = EMPTY_VALUE;
   }
   for (l_shift_4 = Nbars - Length - 1; l_shift_4 >= 0; l_shift_4--) {
      ...
      if (li_8 > 0) {
         if (Signal > 0 && g_ibuf_124[l_shift_4 + 1] == -1.0) {
            g_ibuf_132[l_shift_4] = lda_24[l_shift_4];
            g_ibuf_124[l_shift_4] = lda_24[l_shift_4];
            if (Line > 0) g_ibuf_140[l_shift_4] = lda_24[l_shift_4];
            if (SoundON == TRUE && l_shift_4 == 0 && (!gi_152)) {
            ...
            g_ibuf_124[l_shift_4] = lda_24[l_shift_4];
            if (Line > 0) g_ibuf_140[l_shift_4] = lda_24[l_shift_4];
            g_ibuf_132[l_shift_4] = -1;
         }
         if (Signal == 2) g_ibuf_124[l_shift_4] = 0;
         g_ibuf_136[l_shift_4] = -1;
         g_ibuf_128[l_shift_4] = -1.0;
         g_ibuf_144[l_shift_4] = EMPTY_VALUE;
      }
      if (li_8 < 0) {
         if (Signal > 0 && g_ibuf_128[l_shift_4 + 1] == -1.0) {
            g_ibuf_136[l_shift_4] = lda_20[l_shift_4];
            g_ibuf_128[l_shift_4] = lda_20[l_shift_4];
            if (Line > 0) g_ibuf_144[l_shift_4] = lda_20[l_shift_4];
            if (SoundON == TRUE && l_shift_4 == 0 && (!gi_156)) {
         ...
         if (Signal == 2) g_ibuf_128[l_shift_4] = 0;
         g_ibuf_132[l_shift_4] = -1;
         g_ibuf_124[l_shift_4] = -1.0;
         g_ibuf_140[l_shift_4] = EMPTY_VALUE;
      }
   }
